...
public class AdElectronicsDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad_electronics_details);
        ...
        uploadbtn = (Button)findViewById(R.id.btnElectronicsUpload);
        ...
        if(imageUri != null){
            ...
            fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AdElectronicsDetails.this, e.getMessage(), Toast.LENGTH_LONG).show();
                }
            ...
            Toast.makeText(AdElectronicsDetails.this, "No file Selected", Toast.LENGTH_LONG).show();
        }
    }
