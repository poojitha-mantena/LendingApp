...
public class AdVehicleDetails extends AppCompatActivity {
    ...
    private DatabaseReference mDatabaseRef = db.getReference().child("Vehicle");
    private StorageReference mStorageRef = FirebaseStorage.getInstance().getReference("Image");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ad_vehicle_details);
        ...
        uploadbtn = (Button)findViewById(R.id.btnVehicleUpload);
        ...
        if(imageUri != null){
            ...
            fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    NewModel upload = new NewModel(taskSnapshot.getUploadSessionUri().toString(),
